...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Mon Oct 26 19:49:22 2015
# Project:  task2.pro
# Template: app
...
SensorComponent.o: SensorComponent.cpp SensorComponent.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o SensorComponent.o SensorComponent.cpp

emergency_center.o: emergency_center.cpp emergency_center.h \
		group.h \
		SensorComponent.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o emergency_center.o emergency_center.cpp
